...
This document describes how @sebastienrousseau/biome-config is run: who decides what, how
...
@sebastienrousseau/biome-config is **maintainer-led**. As of the current release line it has a single
