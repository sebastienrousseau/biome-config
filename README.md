...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/biome-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fbiome-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/biome-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14504"><img src="https://img.shields.io/cii/level/14504?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Biome Linter & Formatter Rules](#biome-linter--formatter-rules) — before and after rule comparison
...
Install `@sebastienrousseau/biome-config` as a development dependency:
...
Biome extends another configuration file by path.

### biome.json

```json
{
  "extends": ["./node_modules/@sebastienrousseau/biome-config/biome.json"]
}
```
...
`@sebastienrousseau/biome-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/biome-config` solves this with three deliberate engineering choices:
...
When your repository relies on complex, bespoke ESLint plugins that do not have a direct Biome rule equivalent.
